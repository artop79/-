        ...
        {activeStep === 0 && (
          <Box sx={{ p: 3 }}>
            ...
            >
              ...
              <Typography variant="h6" gutterBottom>
                Перетащите или выберите файл резюме
              </Typography>
              <Typography variant="body2" color="text.secondary">
                Поддерживаемые форматы: PDF, DOC, DOCX, TXT
              </Typography>
        ...
        {activeStep === 1 && (
          <Box sx={{ p: 3 }}>
            ...
            <Typography variant="body2" color="text.secondary" paragraph>
              Укажите требования и навыки, необходимые для данной позиции. Это поможет системе анализировать резюме более точно и сравнивать опыт кандидата с требованиями вакансии.
            </Typography>
            ...
            <TextField
              ...
              rows={8}
              variant="outlined"
              placeholder="Введите или вставьте описание вакансии..."
              value={jobDescriptionFile}
              onChange={handleJobDescriptionChange}
              sx={{ mb: 3 }}
            />
            ...
            <Box sx={{ backgroundColor: alpha(theme.palette.background.default, 0.7), p: 3, borderRadius: 2, mb: 4 }}>
              ...
              <Stack spacing={1}>
                <Typography variant="body2">
                  <strong>Резюме:</strong> {resumeFile ? resumeFile.name : 'Текстовый ввод'}
                </Typography>
                <Typography variant="body2">
